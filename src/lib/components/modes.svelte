<div class="container">
    ...
    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 207.628 207.628" xml:space="preserve">
...
<style>
    ...
    /* Container has a height of 34px and a width of 60px */
    svg {
        height: 17.5px;
        width: 17.5px;
